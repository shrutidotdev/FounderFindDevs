const getFlagEmoji = (countryCode: string) => {
  return countryCode
    .toUpperCase()
    .split('')
    .map((char: string) => String.fromCodePoint(0x1F1E6 + char.charCodeAt(0) - 65))
    .join('');
};
  ...
  export const countryList = [
    ...
    },
    {
      ...
      code: "AQ",
      phoneCode: "+672",
      flagEmoji: getFlagEmoji("AQ"),
    },
    {
      name: "Antigua and Barbuda",
      code: "AG",
      phoneCode: "+1268",
      flagEmoji: getFlagEmoji("AG"),
    },
    {
      name: "Argentina",
      code: "AR",
    ...
    },
    {
      ...
      code: "VG",
      phoneCode: "+1284",
      flagEmoji: getFlagEmoji("VG"),
    },
    {
      name: "Virgin Islands, U.S.",
      code: "VI",
      phoneCode: "+1340",
      flagEmoji: getFlagEmoji("VI"),
    },
    {
      name: "Wallis and Futuna",
      code: "WF",
      phoneCode: "+681",
      flagEmoji: getFlagEmoji("WF"),
    },
    {
      name: "Yemen",
      code: "YE",
